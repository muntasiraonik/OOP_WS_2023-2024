...
void print_consumer(consumer* consumer1, int number) {
    ...
    cout << setw(column_width) << "power consumption " << ": " << right << consumer1->watt << " W" << endl;

    cout << setw(column_width) << "power consumption standby " << ": " << right << consumer1->watt_standby << " W" << endl;

    cout << setw(column_width) << "annual hours of use " << ": " << right << annual_hours_of_use(consumer1) << " h" << endl;

    cout << setw(column_width) << "annual hours of standby " << ": " << right << annual_hours_of_standby(consumer1) << " h" << endl;

    cout << setw(column_width) << "annual consumption " << ": " << right << annual_kWh(consumer1) << " kWh" << endl;

    cout << setw(column_width) << "annual costs " << ": " << right << annual_kWh(consumer1) * price_of_one_kilowatt << " EUR" << endl;
}
...
void print_household(household* household1,float price_of_one_kilowatt) {
    ...
    cout << "-------------------------------------------------- --------------------" << endl;
    cout << setw(column_width) << "city" << ": " << right << household1->city << " " << endl;

    ;

    cout << setw(column_width) << "price for one kWh" << ": " << fixed << setprecision(2) << right << price_of_one_kilowatt*100 << " ct/kWh" << endl;
    
    cout << setw(column_width) << "square meters" << ": " << right << household1->sqr << " qm" << endl;

    cout << setw(column_width) << "persons" << ": " << right << household1->people << endl;

    cout << setw(column_width) << "water heated using electricity" << ": " << right;
    ...
    cout << "-------------------------------------------------- --------------------" << endl;
    cout << setw(column_width) << "power consumption square meters" << ": " << fixed << setprecision(2)<< right << sqr_consumption << " kWh" << endl;

    float person_consumption = household1->people * 550;
    cout << setw(column_width) << "power consumption all persons" << ": " << fixed << setprecision(2) << right << person_consumption << " kWh" << endl;
    ...
    cout << setw(column_width) << "total annual power consumption" << ": " << fixed << setprecision(2) << right <<  total_consumption << " kWh" << endl;

    cout << setw(column_width) << "total annual power costs" << ": " << fixed << setprecision(2) << right << total_consumption * price_of_one_kilowatt << " EUR" << endl;
}
